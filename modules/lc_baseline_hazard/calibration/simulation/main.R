...
# Configuration
# ==============================================================================#
if (!endsWith(getwd(), "modules/lung_cancer/calibration/simulation")) {
  setwd("modules/lung_cancer/calibration/simulation")
}
# Paths settings
data_path <- "../data/"
params_path <- "../params/"
...
colnames(beforeconditions) <- c(
  ...
  "year_lung_cancer",
  "Duration_I", "Duration_II", "Duration_III", "Duration_IV",
  "year_lung_cancer_diagnosed", "stage_diagnosed",
  "smoking_intensity", "Cured", "Lung_specific", "Family_History"
)
